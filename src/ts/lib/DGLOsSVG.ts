...
export class SimulationAttrOpts implements AttrOpts {
	...
	constructor(simulationCollision: boolean = false, simulationWeight: boolean = true, divisorPT: number = 2.75, divisorPX: number = 3.25, alpha: number = .03, charge: number = -100) {
