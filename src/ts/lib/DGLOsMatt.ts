/**
 * Matt's additions to DGLOsSVG.ts
 */

import { DGLOsSVGBaseClass } from './DGLOsSVGBaseClass';
import { Selection } from 'd3-selection';
import { Node, MetaNode, MetaEdge } from '../model/dynamicgraph';
...
export class DGLOsMatt extends DGLOsSVGCombined {
	...
	/**
	 * Initialize and draw all NodeGlyphshapes to a specific Selection, adds
	 * them to Map and sets display to "none".
	 * //TODO: update description for flubber
	 * @param loc: Selection<any, {}, any, {}>
	 */
	protected drawNodeGlyphsAt(loc: Selection<any, {}, any, {}>, drawAtSVGNum?: number): void {
		let numSVGPosition: number = 0;
		if (drawAtSVGNum !== undefined) {
			numSVGPosition = drawAtSVGNum;
		}
		...
		this._nodeGlyphMap.set(numSVGPosition, glyphMap);
	}
	/**
