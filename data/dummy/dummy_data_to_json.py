"""converts dummy_data.tsv to a json file"""

from collections import defaultdict
import json

def translate(infilename, outfilename):
	"""converts infilename (as a tsv) into outfilename (as json)"""
	with open(infilename, 'r') as dummyfile:
		new_timestep = True
		timestamps = []
		people = []
		drinks = []
...
translate('DummyData.tsv', 'dummy.json')
